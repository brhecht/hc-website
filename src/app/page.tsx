...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white text-black">
      <main className="mx-auto max-w-7xl px-6 py-16 md:px-12 lg:px-20 md:py-20">
        {/* Header */}
        ...
        {/* Hero: Two Column */}
        <div className="grid grid-cols-1 md:grid-cols-[1fr_1.5fr] gap-8 md:gap-16 mb-16">
          {/* Left: Big Question */}
          ...
          {/* Right: Pitch + Intro */}
          <div className="md:border-l md:border-[#e3e3e3] md:pl-12">
        ...
        <div className="mb-16">
          ...
          <h3 className="text-sm font-bold tracking-wide uppercase mb-8">
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 items-start">
              <input
                ...
                required
                className="w-full sm:w-72 px-4 py-3 border border-gray-300 rounded-lg text-base focus:outline-none focus:border-black"
              />
              <input
                type="text"
                placeholder="Name"
                ...
                className="w-full sm:w-56 px-4 py-3 border border-gray-300 rounded-lg text-base focus:outline-none focus:border-black"
              />
              <button
                type="submit"
                disabled={submitting}
                className="bg-black text-white px-8 py-3 rounded-lg text-base font-medium hover:bg-gray-800 transition-colors disabled:opacity-50 whitespace-nowrap"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-16">
          {/* Watch the Videos */}
          <div>
            <h3 className="text-2xl font-bold mb-3">Watch the Videos:</h3>
          ...
          {/* Call for Founders */}
          <div>
            <h3 className="text-2xl font-bold mb-3">Call for Founders:</h3>
            <p className="text-base leading-relaxed mb-4">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-black text-white px-8 py-3 rounded-lg text-base font-medium hover:bg-gray-800 transition-colors"
            >
              <svg
        ...
        {/* Bottom Bio Section */}
        <div className="grid grid-cols-1 md:grid-cols-[1.2fr_1fr] gap-16 mb-16">
          {/* Left: Text */}
          <div>
          ...
          <div className="flex items-start justify-center">
            ...
            <img
              ...
              alt="Brian Hecht"
              className="w-full max-w-[420px] rounded-lg object-cover"
            />
          </div>
        </div>

        {/* Footer */}
        <p className="text-center text-sm tracking-widest uppercase text-gray-500">
